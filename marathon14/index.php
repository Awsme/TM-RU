<?php
$version = date("YmdHis");
$shareUrl = 'http://getwebsite.templatemonster.ru/';
							...
							<div class="section-intro_content">
								...
								<div class="section-intro_content_info">
									...
									<div class="hgroup">
										...
										<h4>Хотите получить первый урок бесплатно прямо сейчас?</h4>
									</div>
					...
					<div class="table-cell">
						<div class="form-container">
							...
							<form id="question-form">
								...
								<fieldset>
									<p>
										<input type="text" name="name" class="question-name" placeholder="Укажите свое имя">
									</p>
									<p>
										<input type="email" name="email" class="question-email" placeholder="Укажите свой e-mail:">
									</p>
									<textarea name="question" id="message" class="question-textarea" rows="30" placeholder="Задайте вопрос:"></textarea>
								</fieldset>
