...
class WebStudioApplication extends Moto_Application
{
	private $_defaults = array(
		...
		'adminEmail' => 'ru@templatemonster.com',
		'adminName' => 'Гриша Пиксель (TemplateMonster Russia)',
		'text' => 'Дорогой друг!
<br /><br />
Мы получили твою заявку на участие в марафоне «Своя веб-студия за 61 день» (если впервые слышишь это название, то просто проигнорируй письмо, сотри, не читай, живи себе как жил).
<br /><br />
...
из TemplateMonster Russia',
	...
	public function subscribe($email)
	{
		...
		$link = '<a href="' . $landing_url[0]. '?app=web-studio&id='
